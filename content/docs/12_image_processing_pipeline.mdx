...
This document zooms in on the transformation phase that runs after imgforge validates a request. Use it alongside [Processing Options](5_processing_options) to design URLs and reason about how directives interact inside libvips.
